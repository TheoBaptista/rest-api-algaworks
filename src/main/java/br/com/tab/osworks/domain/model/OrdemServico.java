package br.com.tab.osworks.domain.model;
...
import br.com.tab.osworks.domain.ValidationGroups;
...
public class OrdemServico {
	...
	public void finalizar() {
		...
		if (naoPodeSerFinalizada()) {
			throw new BusinessException("Ordem de servico nao pode ser finalizada");
		}
